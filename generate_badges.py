...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Dossiers supplémentaires contenant les logos d'entreprise. "
            "Les fichiers doivent être nommés d'après le nom de l'entreprise"
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Désactive la recherche automatique de logos en ligne via Clearbit."
        ),
    )
